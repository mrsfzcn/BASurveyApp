...
class SurveyServiceTest {
    ...
    void responseSurveyQuestions_ShouldSaveResponses_WhenAllQuestionsAreAnsweredAndSurveyIsAnswerOnlyOnce() {
        ...
        when(jwtService.isSurveyEmailTokenValid(token)).thenReturn(true);
        ...
        when(jwtService.extractEmail(token)).thenReturn(can.getEmail());
        when(userRepository.findByEmail(can.getEmail())).thenReturn(Optional.of(can));
