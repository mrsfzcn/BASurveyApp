...
export default function Sidebar({ onSubMenuClick }){
            ...
            <section className="sb-btn">
                ...
                {isPollMenuOpen && (
                    <div className="sub-menu">
                        ...
                        <button onClick={() => handleSubMenuClick("survey-tags")}>
                ...
                {isQuestionMenuOpen && (
                    <div className="sub-menu">
                        ...
                        <button onClick={() => handleSubMenuClick("question-tags")}>
                ...
                {isClassMenuOpen && (
                    <div className="sub-menu">
                        ...
                        <button onClick={() => handleSubMenuClick("classroom-tags")}>
